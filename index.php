...
// 接続エラーの確認
if( $mysqli->connect_errno ) {
    $error_message[] = 'データの書き込みに失敗しました。　エラー番号'.$mysqli->connect_errno.' : '.$mysqli->connect_error;
} else {
...
<article>
    <div class="info">
        ...
        <time><?php echo date('Y年m月s日 H:i', strtotime($value['post_date'])); ?></time>
    </div>
